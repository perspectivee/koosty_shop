...
const OrderNow = () => {
  return (
    <form id='order-now' className="w-full flex flex-col gap-[2rem] items-center mb-[200px]">
      <label htmlFor="order-now" className="order-now-label text-[2.5rem] uppercase">Order now!</label>
